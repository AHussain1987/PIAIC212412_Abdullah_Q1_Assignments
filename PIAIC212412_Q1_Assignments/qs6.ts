...
let theName: string = "  Ab\n  d\tu  l\nla\th";
console.log("Name including white spaces is:\n" + theName);

//stripping the white spaces
let stripSpace: string[] = theName.split(""); //splitting the string into an array of substrings using split()
...
console.log(
  "Name after stripping the white spaces is:\n" + stripSpace.join("")
);
